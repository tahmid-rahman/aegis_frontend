...
export default function SignUp() {
  ...
  // Type the handleChange function
  ...
  // Type the DateTimePicker onChange event
  const onDateChange = (
    event: any, // You can use a more specific type if needed (e.g., NativeSyntheticEvent<DateTimePickerEvent>)
    selectedDate?: Date
  ) => {
      ...
      <ScrollView contentContainerStyle={{ padding: 24 }} keyboardShouldPersistTaps="handled">
        ...
        <View className="space-y-4 mb-6">
          ...
          <View>
            ...
            <TextInput
              className="bg-surface-variant rounded-xl p-4 text-on-accent border border-outline"
